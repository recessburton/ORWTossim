...
/*===========================================================
 * 						YTC 2016.9.5 
 * 	TinyOS release 2.1.2版， 使用就的make工具，无法支持C99，出现
 * restrict关键字无法识别的错误；使用github中新的TinyOS 3.x新版
 * make工具则无编译错误。此处手动定义restrict。
 * ==========================================================
 * */
#   define restrict         /* restrict */
/*===========================================================
 ...
 * @see list_size()
 */
int list_isempty(const list_t *restrict l);
